...
# Start executions
aws stepfunctions --endpoint-url http://localhost:8084 start-execution \
    --state-machine-arn arn:aws:states:us-east-1:123456789012:stateMachine:Hello-World \
    --input '{"foo": "bar"}'
aws stepfunctions --endpoint-url http://localhost:8084 start-execution \
    --state-machine-arn arn:aws:states:us-east-1:123456789012:stateMachine:Hello-World \
...
aws stepfunctions --endpoint-url http://localhost:8084 start-execution \
    --state-machine-arn arn:aws:states:us-east-1:123456789012:stateMachine:Parallel \
    --input '{"foo": "bar"}'
aws stepfunctions --endpoint-url http://localhost:8084 start-execution \
    --state-machine-arn arn:aws:states:us-east-1:123456789012:stateMachine:Parallel \
    --input '{"daz": "maz"}'
